  ...
  return (
    <>
      <div className="colPerso datosPerso col1-1 mt-3">
        ...
        <div className="text-start d-flex">
          <a className="fw-italic ps-1 ms-auto" href="https://www.linkedin.com/in/mark-zuckerberg-618bba58/">
          <img className="iconoLink" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/LinkedIn_logo_initials.png/640px-LinkedIn_logo_initials.png"></img>
